...
import yitgogo.smart.local.model.ModelLocalSaleTejiaDetail;
...
public class LocalSaleTejiaDetailFragment extends BaseNotifyFragment implements
		OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.fragment_local_sale_tejia_detail);
		init();
		findViews();
	}
	...
	protected void findViews() {
		...
		nameTextView = (TextView) contentView
				.findViewById(R.id.local_sale_tejia_detail_name);
		priceTextView = (TextView) contentView
				.findViewById(R.id.local_sale_tejia_detail_price);
		unitTextView = (TextView) contentView
				.findViewById(R.id.local_sale_tejia_detail_unit);
		stateTextView = (TextView) contentView
				.findViewById(R.id.local_sale_tejia_detail_state);

		buyButton = (TextView) contentView
				.findViewById(R.id.local_sale_tejia_detail_buy);
	...
	private void showDetail() {
		if (localSaleTejiaDetail != null) {
			qrEncodeProduct(localSaleTejiaDetail.getProductId(),
					localSaleTejiaDetail.getNumber(),
					localSaleTejiaDetail.getProductName(),
					QrCodeTool.PRODUCT_TYPE_LOCAL_GOODS,
					QrCodeTool.SALE_TYPE_LOCAL_TEJIA, new OnQrEncodeListener() {
						@Override
			...
			webView.loadData(localSaleTejiaDetail.getProductDetais(),
	...
	public void onClick(View v) {
		...
		case R.id.local_sale_tejia_detail_buy:
			buy();
			break;
	...
	private void buy() {
		if (localSaleTejiaDetail != null) {
			...
			bundle.putString("object", localSaleTejiaDetail.getJsonObject()
					.toString());
			openWindow(LocalSaleTejiaBuyFragment.class.getName(), "购买商品",
					bundle);
		}
	}
	...
	private class ImageAdapter extends PagerAdapter {
		...
		public Object instantiateItem(ViewGroup view, int position) {
			...
			imageLoader.displayImage(getBigImageUrl(localSaleTejiaDetail
	...
	private void getDetail() {
		NetworkContent networkContent = new NetworkContent(
				API.API_LOCAL_SALE_TEJIA_DETAIL);
